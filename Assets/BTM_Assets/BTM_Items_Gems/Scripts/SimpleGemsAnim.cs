...
namespace Benjathemaker
{
    public class SimpleGemsAnim : MonoBehaviour
    {
        ...
        private float spawnDirection = 1f;  // Locked at spawn time
        ...
        void Start()
        {
            ...
            // Lock float direction at spawn — never changes after this
            spawnDirection = AntiGravityManager.Instance != null && AntiGravityManager.Instance.IsAntiGravity
                ? -1f
                : 1f;
        }
        ...
        void Update()
        {
            ...
            if (isFloating)
            {
                ...
                transform.position = initialPosition + new Vector3(0, spawnDirection * t * floatHeight, 0);
            }
